...
<div class="topnav">
    <div class="topnav_bd w990 bc">
        ...
        <div class="topnav_right fr">
            <ul>
                <?php if(!empty($_SESSION['user_name'])): ?><li>您好 <?php echo (session('user_name')); ?>，欢迎来到京西！[<a href="<?php echo U('User/logout');?>">退出系统</a>] </li>
                    <li class="line">|</li>
                    <li>我的订单</li>
                    <li class="line">|</li>
                    <li>客户服务</li>
...
<div class="header w1210 bc mt15">
    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd">
                <?php if(is_array($cat_infoA)): foreach($cat_infoA as $key=>$v1): ?><div class="cat item1">
                        <h3><a href=""><?php echo ($v1["cat_name"]); ?></a> <b></b></h3>
                        <div class="cat_detail">
                            <?php if(is_array($cat_infoB)): foreach($cat_infoB as $key=>$v2): if(($v2["cat_pid"]) == $v1["cat_id"]): ?><dl class="dl_1st">
                                    <dt><a href=""><?php echo ($v2["cat_name"]); ?></a></dt>
                                    <dd>
                                        <?php if(is_array($cat_infoC)): foreach($cat_infoC as $key=>$v3): if(($v3["cat_pid"]) == $v2["cat_id"]): ?><a href=""><?php echo ($v3["cat_name"]); ?></a><?php endif; endforeach; endif; ?>
                                    </dd>
...
<!-- 头部 end-->
	...
	<div class="colligate w1210 bc mt10">
		...
		<div class="slide fl">
			<div class="area">
				<div class="slide_items">
					<ul>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>index_slide1.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>index_slide2.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>index_slide3.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>index_slide4.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>index_slide5.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>index_slide6.jpg" alt="" /></a></li>
					</ul>
				</div>
		...
		<div class="coll_right fl ml10">
			<div class="ad"><a href=""><img src="<?php echo (C("IMG_URL")); ?>ad.jpg" alt="" /></a></div>
			...
			<div class="service mt10">
				...
				<div class="service_wrap">
					...
					<div class="travel none">
						<ul>
							<li>
								<a href=""><img src="<?php echo (C("IMG_URL")); ?>holiday.jpg" alt="" /></a>
								<a href="" class="button">度假查询</a>
							</li>
							<li>
								<a href=""><img src="<?php echo (C("IMG_URL")); ?>scenic.jpg" alt="" /></a>
					...
					<div class="lottery none">
						<p><img src="<?php echo (C("IMG_URL")); ?>lottery.jpg" alt="" /></p>
					</div>
					<!-- 彩票 end -->
					...
					<div class="game none">
						<ul>
							<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>sanguo.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>taohua.jpg" alt="" /></a></li>
							<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>wulin.jpg" alt="" /></a></li>
						</ul>
					</div>
					<!-- 游戏 end -->
				</div>
	...
	<div class="guide w1210 bc mt15">
			...
			<div class="guide_wrap">
				...
				<div class="crazy">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>crazy1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>crazy2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>crazy3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>crazy5.jpg" alt="" /></a></dt>
				...
				<div class="hot none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>hot1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>hot2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>hot3.jpg" alt="" /></a></dt>
				...
				<div class="recommend none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>recommend1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>recommend2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>recommend3.jpg" alt="" /></a></dt>
				...
				<div class="new none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>new1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>new2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>new3.jpg" alt="" /></a></dt>
				...
				<div class="guess none">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>guess1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>guess2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>guess3.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href=""><img src="<?php echo (C("IMG_URL")); ?>viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href=""><img src="<?php echo (C("IMG_URL")); ?>samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					...
					<p><a href=""><img src="<?php echo (C("IMG_URL")); ?>notebook.jpg" alt="" /></a></p>
				</div>
				...
				<div class="goodslist_wrap">
					<div>
						<ul>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>thinkpad e420.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>samsung6800.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>lh531.jpg" alt="" /></a></dt>
							...
							<li>
								<dl>
									<dt><a href=""><img src="<?php echo (C("IMG_URL")); ?>qinghuax2.jpg" alt="" /></a></dt>
		...
		<div class="sidebar fl ml10">
			...
			<div class="brand">
				...
				<div class="sidebar_wrap">
					<ul>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>dell.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>acer.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>fujitsu.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>hp.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>lenove.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>samsung.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>dlink.gif" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>seagate.jpg" alt="" /></a></li>
						<li><a href=""><img src="<?php echo (C("IMG_URL")); ?>intel.jpg" alt="" /></a></li>
					</ul>
				</div>
			</div>
			<!-- 品牌旗舰店 end -->
			...
			<!-- 广告 start -->
			<div class="ads mt10">
				<a href=""><img src="<?php echo (C("IMG_URL")); ?>canon.jpg" alt="" /></a>
			</div>
			<!-- 广告 end -->
		</div>
		<!-- 右侧 end -->
